...
namespace DAL
{
    public class SQLHelper
    {
        ...
        //public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|news.mdb";
        ...
        /// <param name="strSql">Sql语句</param>
        /// <returns></returns>
        public static int GetMinID(string strSql)
        {
            object obj = SQLHelper.GetSingle(strSql);
            if (obj == null)
            {
        ...
        public static int ExecuteSqlInsertImg(string strSQL, byte[] fs)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                ...
                System.Data.OleDb.OleDbParameter myParameter = new System.Data.OleDb.OleDbParameter("@fs", OleDbType.VarChar);
        ...
        /* private static OleDbCommand BuildIntCommand(OleDbConnection connection, string storedProcName, IDataParameter[] parameters)
         {
             ...
             command.Parameters.Add(new OleDbParameter("ReturnValue",
                 OleDbDbType.Int, 4, ParameterDirection.ReturnValue,
                 false, 0, 0, string.Empty, DataRowVersion.Default, null));
             return command;
         }
         */
        public static string RunMyProcedure(string storedProcName, IDataParameter[] parameters)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                string result = "";
                ...
                result = (string)command.Parameters["@msgResult"].Value;
                connection.Close();
                return result;
            }
        }
        ...
        /// <param name="path">备份的文件名，包含完整路径</param>
        /// <returns></returns>
        public static int DatabaseBak(string dbName, string pathDB)
        {
            int num = 0;
        ...
        public static int DatabaseRestor(string dbName, string pathDB)
        {
            int num = 0;
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
